...
import (
	...
	"github.com/DaHuangQwQ/webook/internal/article"
	"github.com/DaHuangQwQ/webook/internal/interactive"
	//articlev1 "github.com/DaHuangQwQ/webook/internal/api/proto/gen/article/v1"
	//intrv1 "github.com/DaHuangQwQ/webook/internal/api/proto/gen/interactive/v1"
	//rewardv1 "github.com/DaHuangQwQ/webook/internal/api/proto/gen/reward/v1"
	"github.com/DaHuangQwQ/webook/internal/bff/api"
	"github.com/DaHuangQwQ/webook/internal/bff/web/jwt"
...
func (a *ArticleHandler) Withdraw(ctx *gin.Context) {
	...
	err := a.svc.Server.Withdraw(ctx, usr.Id, req.Id)
	if err != nil {
...
func (a *ArticleHandler) List(ctx *gin.Context, req api.GetArticleListReq, usr jwt.UserClaims) (ginx.Result, error) {
	...
	//}
	//
	//arts, err := a.svc.Server.ListPub(ctx, api.PageReq{Author: usr.Id,
